...
python u_net_experiment_bowl_2018.py 0

echo "Running script with standard dropout"
python u_net_experiment_bowl_2018.py 1

echo "Running script with max pool dropout"
python u_net_experiment_bowl_2018.py 2

echo "Running script with both standard and maxpool dropout"
python u_net_experiment_bowl_2018.py 3
